...
pub struct BlockchainState {
    ...
    /// Optional fallback read-only contract using a different RPC endpoint.
    /// When the primary RPC returns HTTP 429 or times out, the keeper will
    /// retry the event query against this fallback provider.
    pub fallback_contract: Option<Arc<dyn EntropyReader>>,
    ...
    async fn test_chain_configs_with_data() {
        ...
        config_chains.insert(
            ...
            crate::config::EthereumConfig {
                ...
                fallback_rpc_addr: None,
                ws_rpc_addr: None, mined_tx_ws_rpc_addr: None,
