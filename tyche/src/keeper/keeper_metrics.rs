...
pub struct KeeperMetrics {
    ...
    pub accrued_dice_fees: Family<ChainIdLabel, Gauge<f64, AtomicU64>>,
...
impl Default for KeeperMetrics {
    fn default() -> Self {
        Self {
            ...
            accrued_dice_fees: Family::default(),
...
impl KeeperMetrics {
    pub async fn new(registry: Arc<RwLock<Registry>>) -> Self {
        ...
        writable_registry.register(
            "accrued_dice_fees",
            "Accrued Dice fees on the contract",
            keeper_metrics.accrued_dice_fees.clone(),
        );
    ...
    pub fn add_chain(&self, chain_id: String, provider_address: Address) {
        ...
        let _ = self.accrued_dice_fees.get_or_create(&chain_id_label);
